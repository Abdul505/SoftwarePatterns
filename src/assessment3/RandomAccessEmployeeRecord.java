...
public class RandomAccessEmployeeRecord extends Employee implements IRandomAccessEmployeeRecord
{  
    // Create empty record
   ...
   /* (non-Javadoc)
 * @see assessment3.IRandomAccessEmployeeRecord#read(java.io.RandomAccessFile)
 */
@Override
public void read( RandomAccessFile file ) throws IOException
   ...
   /* (non-Javadoc)
 * @see assessment3.IRandomAccessEmployeeRecord#write(java.io.RandomAccessFile)
 */
@Override
